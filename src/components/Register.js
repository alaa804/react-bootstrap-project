...
import video from "../video/developer.mp4";
import { rubberBand, zoomIn } from "react-animations";
import Radium, { StyleRoot } from "radium";

const styles = {
  bounce: {
    animation: "bounce 4s",
    animationName: Radium.keyframes(rubberBand, "bounce"),
    color: "#4286f4",
  },
};
                ...
                <div className="brand-col">
                  <div className="headline">
                    <div className="brand-logo">
                      <StyleRoot>
                        <h3 style={styles.bounce}>Bootcamp</h3>
                      </StyleRoot>
                    </div>
                        ...
                        >
                          ...
                          <div className="row remember-row">
                            <div className="col-xs-6 col-sm-6">
                              <label
                                className="form-checkbox d-flex f-2"
                          ...
                          <div className="form-group">
                            <StyleRoot>
                              <a
                                ...
                                href="!#"
                                target="_blank"
                                className="btn btn-lg btn-primary btn-block flip"
                                type="button"
                              >
                                Login with email
                              </a>
